<<<<<<< HEAD
# eCommerce-Website-Template-Laravel-10-Bootstrap-5
The frontend design template of an eCommerce Website made with Laravel 10 + Bootstrap 5 + CSS + JS.
# Source of the original template
...
>>>>>>> bf5c8de (upload files for the 1st time)
